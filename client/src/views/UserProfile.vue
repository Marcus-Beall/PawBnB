  ...
  <div class="profile">
    ...
    <form>
      ...
      <div class="form-group">
        ...
        <input type="text" id="pet-type" class="form-control" />
      </div>
      <div class="form-group">
        <label for="pet-img">Pet Image</label>
        <input type="text" id="pet-image" class="form-control" />
      </div>
      <div class="form-group">
        <label for="pet-contact">Contact Information</label>
        <input type="text" id="pet-contact" class="form-control" />
      </div>
      <div class="form-group">
        <label for="pet-notes">Notes/Special Needs</label>
        <input type="text" id="pet-notes" class="form-control" />
      </div>
